...
export const CONSUMER_OUTCOMES: readonly ConsumerOutcome[] = [
  ...
  },
  {
    ...
    cta: "Set the room for massage",
    homeFormat: "Room format · duration planned",
    plannedFormat: "Future room format · duration options in production",
  ...
  },
  {
    ...
    functionLabel: "RELAX",
    cta: "Relax now",
    homeFormat: "Reset · duration planned",
    plannedFormat: "Future reset format · duration options in production",
  ...
  },
  {
    ...
    homeFormat: "Wind-down · duration planned",
    plannedFormat: "Future wind-down format · duration options in production",
  ...
  },
  {
    ...
    functionLabel: "FOCUS",
    cta: "Focus",
    homeFormat: "Work block · duration planned",
    plannedFormat: "Future work-block format · duration options in production",
