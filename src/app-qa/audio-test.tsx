  ...
  return (
    <AmbientScreen washColors={["#C4AFD3", "#8FAFC6"]}>
      ...
      <Text style={styles.intro}>
        Moon Current combines three ATP01 WAV files to validate the audio
        engine. This technical arrangement is not part of the consumer
        catalogue. Moon Drone and Deep River reuse two recordings independently.
      </Text>
